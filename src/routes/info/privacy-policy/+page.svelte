		...
		<div class="row py-4 my-4">
			<div class="col offset-lg-1 col-lg-9">
				...
				<ul>
					...
					<li><p><strong>Country</strong> refers to: Georgia, United States</p></li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to QUANTU, accessible from
							<a href="https://quantu.app">https://quantu.app</a>
						</p>
					</li>
					<li>
						<p>
				...
				<h5 id="personal-data">Personal Data</h5>
				<p>
				...
				<h5 id="usage-data">Usage Data</h5>
				...
				<h5 id="tracking-technologies-and-cookies">Tracking Technologies and Cookies</h5>
				<p>
				...
				<ul>
					...
					<li>
						...
						<a
							...
							>https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling_<em
								>or_deleting_local_shared_objects</em
							></a
						>
					</li>
					<li>
				...
				<p>
					...
					as soon as You close Your web browser. Learn more about cookies: <a
